             ...
             <div className="lg:w-1/3">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                           เราไม่ได้เป็นเพียงผู้ให้บริการฝึกอบรม แต่เราคือนวัตกรรมความปลอดภัยที่ช่วยขับเคลื่อนองค์กรของคุณไปสู่อนาคต ด้วยเครื่องมือที่ทันสมัยและหลักสูตรที่ออกแบบมาเพื่อผลลัพธ์ที่เป็นรูปธรรม
                    </p>
