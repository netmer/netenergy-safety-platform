...
import { ExamsClientPage } from '@/app/erp/exams/exams-client-page';
...
export default async function AdminExamsPage() {
    ...
    return <ExamsClientPage templates={templates} courses={courses} categories={categories} basePath="/admin/exams" />;
}
